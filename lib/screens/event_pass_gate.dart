...
import 'package:sentinova_hackfest/components/qr_cards.dart';
import 'package:sentinova_hackfest/components/key_input_field.dart';
import 'package:sentinova_hackfest/services/api_service_events.dart';
...
class _EventPasswordGateState extends State<EventPasswordGate> {
  ...
  void _checkPassword(String input) async {
    if (input.trim().isNotEmpty) {
      ...
      final data = await api.fetchEvents();
